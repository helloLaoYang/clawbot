...
section{border:1px solid #dfe6e9;border-radius:12px;padding:20px}input,button{font:inherit;padding:10px 12px;border-radius:8px;border:1px solid #b2bec3}
button{background:#1677ff;color:white;border:0;cursor:pointer}pre{white-space:pre-wrap;background:#f5f6fa;padding:12px;border-radius:8px}img{max-width:280px}
...
const token=document.querySelector('#token'),out=document.querySelector('#out'),qr=document.querySelector('#qr'),verify=document.querySelector('#verify');
